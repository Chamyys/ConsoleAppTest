...
//builder.Configuration.AddJsonFile("/home/egor/RiderProjects/DB/DB/1.json");
//builder.Services.Configure<JSONPATH>(builder.Configuration);

builder.Configuration.AddJsonFile("/home/egor/RiderProjects/ConsoleAppTest/WebApplication/app-settings.json");
builder.Services.Configure<JSONPATH>(builder.Configuration.GetSection("JSONPATH"));
